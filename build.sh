...
### RSS的参考链接1：https://sspai.com/post/62332
### 生成 RSS 的原理就是在 GitHub 平台上通过 Travis CI 服务，自动化生成 RSS 文件，使用 Git 来查找最新的 10 个文件和更新时间，使用 Pandoc 将 MarkDown 内容转为 HTML
...
feed="feed.xml"
blog_title="Tenloy's Blog"
blog_link="https://tenloy.github.io"
