...
<img src="/images/encrypt/02.png" alt="02" style="zoom:80%;" />
...
<img src="/images/encrypt/03.png" alt="02" style="zoom:80%;" />
...
<img src="/images/encrypt/04.png" alt="02" style="zoom:80%;" />
...
### 2.3 轮函数拆解：字节代换（Substitute Bytes）

<img src="/images/encrypt/05.png" alt="02" style="zoom:70%;" />
...
<img src="/images/encrypt/06.jpg" alt="02" style="zoom:75%;" />
...
```
### 2.4 轮函数拆解：行移位（Shift Rows）

<img src="/images/encrypt/07.png" alt="02" style="zoom:80%;" />
...
```
### 2.5 轮函数拆解：列混合（Mix Columns）

<img src="/images/encrypt/08.png" alt="02" style="zoom:75%;" />
...
```
### 2.6 轮函数拆解：轮密钥加（Add Round Key）

<img src="/images/encrypt/09.png" alt="02" style="zoom:75%;" />
...
对Rijndael算法来说，**解密过程就是加密过程的逆向过程**，其解密轮函数实现如下：
```c
...
<img src="/images/encrypt/11.png" alt="02" style="zoom:100%;" />
...
<img src="/images/encrypt/12.png" alt="02" style="zoom:50%;" />

经ECB模式加密的图片：

<img src="/images/encrypt/13.png" alt="02" style="zoom:50%;" />
...
<img src="/images/encrypt/14.jpg" alt="02" style="zoom:50%;" />
...
<img src="/images/encrypt/15.png" alt="02" style="zoom:70%;" />
...
<img src="/images/encrypt/16.png" alt="02" style="zoom:70%;" />
...
<img src="/images/encrypt/19.png" alt="02" style="zoom:95%;" />
...
1.  [https://github.com/matt-wu/AES/](https://github.com/matt-wu/AES/)
